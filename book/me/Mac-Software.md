...
|        Name       |       Purpose       |        Url        | 
|    ------------   |    -------------    |  :-------------:  | 
|     `Cisco AnyConnect`            |   VPN for Rice University                  |  [link-1](https://its.gmu.edu/knowledge-base/how-to-install-cisco-anyconnect-on-a-mac/) or [link](https://software.cisco.com/download/home)                 |            
|     ``            |                     |                   | 
|     ``            |                     |                   |            
|     ``            |                     |                   | 
