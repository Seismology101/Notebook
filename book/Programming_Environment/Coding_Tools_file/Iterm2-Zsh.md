...
- Double click to install those `ttf` file in your Mac. And set the font option in `~/.zshrc` as following, or you can download in my [Github](https://github.com/OUCyf):
