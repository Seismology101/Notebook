...
:::{note}
`sudo` permission is required to modify `/etc/hosts`. Make sure to back up the original files; The script will update the content between line from # GitHub520 Host Start to # GitHub520 Host End, without deleting or modifying anything else.
:::
